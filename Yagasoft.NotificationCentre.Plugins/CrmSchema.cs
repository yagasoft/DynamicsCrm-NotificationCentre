...
namespace Yagasoft.NotificationCentre.Plugins
{
	...
	public partial class GenericConfiguration : GeneratedEntity<GenericConfiguration.RelationName>
	{
        ...
        /// </summary>
		[AttributeLogicalName("ldv_assemblyexclusion"), MaxLength(4000)]
		public string AssemblyExclusion
		{
			get
			{
				var value = GetAttributeValue<string>("ldv_assemblyexclusion");
				if (value == null && backupAttributeCollection != null && backupAttributeCollection.Contains("ldv_assemblyexclusion"))
				    value = (string) backupAttributeCollection["ldv_assemblyexclusion"];
			    return value;
			}
			set
			{
				OnPropertyChanging("AssemblyExclusion");
					SetAttributeValue("ldv_assemblyexclusion", value);
				OnPropertyChanged("AssemblyExclusion");
			}
		}
        ...
        /// </summary>
		[AttributeLogicalName("ldv_assemblyfilter"), MaxLength(4000)]
		public string AssemblyFilter
		{
			get
			{
				var value = GetAttributeValue<string>("ldv_assemblyfilter");
				if (value == null && backupAttributeCollection != null && backupAttributeCollection.Contains("ldv_assemblyfilter"))
				    value = (string) backupAttributeCollection["ldv_assemblyfilter"];
			    return value;
			}
			set
			{
				OnPropertyChanging("AssemblyFilter");
					SetAttributeValue("ldv_assemblyfilter", value);
				OnPropertyChanged("AssemblyFilter");
			}
		}
